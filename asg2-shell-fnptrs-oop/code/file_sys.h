...
enum file_type {PLAIN_TYPE, DIRECTORY_TYPE};
class inode;
class base_file;
class plain_file;
class directory;
...
class directory: public base_file {
   ...
   public:
      ...
      virtual void writefile (const wordvec& newdata) override;
      virtual void remove (const string& filename) override;
      virtual inode_ptr mkdir (inode_state& state, const wordvec& words);
      virtual inode_ptr mkfile (inode_state& state, const wordvec& words);
      void print_path(inode_state& state);
      void print_tmp_path(inode_state& state);
      void ls(inode_state& state, const wordvec& words);
      void get_to_dir(inode_state& state, const wordvec& words);
      void get_to_file(inode_state& state, const wordvec& words);
