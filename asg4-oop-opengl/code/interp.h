...
class interpreter {
   ...
   private:
      ...
      static shape_ptr make_triangle (param begin, param end); //new
      static shape_ptr make_equilateral (param begin, param end); //new
      static shape_ptr make_diamond (param begin, param end); //new
};
